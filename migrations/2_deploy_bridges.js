const CrosspolySwapETHUniswapBridge = artifacts.require("CrosspolySwapETHUniswapBridge");
const CrosspolySwapBSCPancakeBridge = artifacts.require("CrosspolySwapBSCPancakeBridge");
const CrosspolySwapHecoMdexBridge = artifacts.require("CrosspolySwapHecoMdexBridge");
...
function deployETHUniswapMainnet(deployer, network) {
    ...
    deployer.deploy(CrosspolySwapETHUniswapBridge, WETH, UniSwapFactory, polySwapper, polySwapperId);
}
...
function deployBSCPancakeMainnet(deployer, network) {
    ...
    deployer.deploy(CrosspolySwapBSCPancakeBridge, WBNB, pancakeFactory, polySwapper, polySwapperId);
}
